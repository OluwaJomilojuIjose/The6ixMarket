...
public class CreateListingActivity extends AppCompatActivity {
    ...
    private void saveListing(String title, String price, String imageUri, String description, String country, String postalCode) {
        ...
        if (currentUser != null) {
            ...
            values.put(DatabaseHelper.COLUMN_SELLER, sellerName != null ? sellerName : "Seller");
            values.put(DatabaseHelper.COLUMN_SELLER_ID, sellerId); // Store seller UID
        } else {
            values.put(DatabaseHelper.COLUMN_SELLER, "Unknown Seller");
            values.put(DatabaseHelper.COLUMN_SELLER_ID, ""); // Empty if no user
        }
